...
{
    [TestClass]
    public class ShowTooltipServiceTests
    {
        [DataTestMethod]
        ...
        {
            var output = ShowTooltipService.GetColoredString(text, fgColor, bgColor);
        ...
        {
            var output = ShowTooltipService.ConvertHexToRgb(input);
